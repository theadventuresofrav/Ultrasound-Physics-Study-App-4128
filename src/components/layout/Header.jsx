...
const {FiTarget, FiUsers, FiBarChart2, FiMenu, FiLogOut, FiUser, FiMapPin, FiCrown, FiTool, FiBook} = FiIcons;

const Header = () => {
  const location = useLocation();
  const {user, logout, hasRole, membership, MEMBERSHIP_TIERS} = useAuth();
